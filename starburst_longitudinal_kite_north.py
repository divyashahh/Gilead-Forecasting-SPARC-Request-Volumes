...
df_north = df_north[(df_north.organization_flag == 'Kite')]
preserve_columns = ['ds', 'y']
df_north = df_north.filter(items = preserve_columns)
df_north['ds'] = pd.DatetimeIndex(df_north['ds'])
df_north.dtypes
...
prep_df = prep_df[(prep_df['gilead_location_level1'] == 'North America (Geographic)') & (prep_df['organization_flag'] == 'Kite')]
preserve_columns = ['ds', 'y']
